...
public class MainActivity extends TabActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabContact.setIndicator("Contact", getResources().getDrawable(R.drawable.ic_launcher));
		...
		tabInvited.setIndicator("Invited", getResources().getDrawable(R.drawable.ic_launcher));
		...
		tabProfile.setIndicator("Profile", getResources().getDrawable(R.drawable.ic_launcher));
